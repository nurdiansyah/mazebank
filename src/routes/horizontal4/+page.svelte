	...
	>
		<div class="row-span-2 col-span-2 p-4">
			<div class="w-full h-full rounded-lg shadow-right-bottom">
				<!-- Test Gambar -->
				<!-- <img class="w-full h-full rounded-lg shadow-right-bottom" src="/asset/asset_main_content/picture-test-3.png" alt="" /> -->
		...
		<div class="p-4">
			<!-- Loket -->
			<div class="bg-mainColor2 col-span-2 h-full flex items-center rounded-xl shadow-right-bottom px-6 py-4">
				<div class="w-1/2">
					<p
		...
		<div class="col-span-2 p-4">
			<!-- Kurs Info -->
			<div class="bg-mainColor2 col-span-2 h-full flex rounded-xl shadow-right-bottom px-6 py-4">
				<div class=" w-full h-full grid grid-cols-4 grid-rows-2 gap-4">
					<div class="row-span-2 flex justify-center">
						<img src="/asset/asset_main_content/Flag_USA.svg" alt="Logo" class="w-28 drop-shadow-md" />
					</div>
					<div class="row-span-2 flex justify-center">
						<p
