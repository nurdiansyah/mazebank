<footer class="container mx-auto px-4 py-8 sm:px-6 md:px-8">
	...
	<div class="sm:flex sm:items-center sm:justify-between">
		<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
			>© 2023 <a href="/account/home" target="_blank" class="hover:underline">Flowbite™</a>. All
			Rights Reserved.
		</span>
		<div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
			<a href="/account/home" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
